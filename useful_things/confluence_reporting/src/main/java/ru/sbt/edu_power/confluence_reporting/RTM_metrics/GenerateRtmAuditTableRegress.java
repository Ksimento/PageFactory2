...
import ru.sbt.edu_power.confluence_reporting.RTM_metrics.applied_metrics.AbstractMetrics;
import ru.sbt.edu_power.confluence_reporting.RTM_metrics.applied_metrics.ApplyMetrics;
import ru.sbt.edu_power.confluence_reporting.RTM_metrics.applied_metrics.TestCaseInRootFolder;
import ru.sbt.edu_power.confluence_reporting.RTM_metrics.applied_metrics.TestCaseNotExecutionOverHalfYear;
import ru.sbt.edu_power.confluence_reporting.RTM_metrics.applied_metrics.TestCaseStatusNotApproved;
import ru.sbt.edu_power.confluence_reporting.RTM_metrics.applied_metrics.TestTypeNotRegress;
import ru.sbt.edu_power.confluence_reporting.RTM_metrics.applied_metrics.WithoutAutomator;
import ru.sbt.edu_power.confluence_reporting.RTM_metrics.applied_metrics.WithoutFramework;
import ru.sbt.edu_power.confluence_reporting.RTM_metrics.applied_metrics.WithoutSteps;
import ru.sbt.edu_power.confluence_reporting.RTM_metrics.applied_metrics.WithoutStoryLinks;
import ru.sbt.edu_power.confluence_reporting.RTM_metrics.applied_metrics.WithoutSystemRequirementsLink;
...
@Slf4j
public class GenerateRtmAuditTableRegress extends ConfluenceDocument {
    ...
    public GenerateRtmAuditTableRegress(final String pageID, final String projectKey) {
        super(pageID);
        ...
        queryBuilder.addField(TCFields.FOLDER, NewJiraTCCollector.getInstance().getFolderId("Регресс", project.id));
    ...
    public void generate() {
        ...
        applyMetrics.apply(metricsMap.get(TestCaseStatusNotApproved.class), TableHeader.TEST_STATUS);
        applyMetrics.apply(metricsMap.get(TestTypeNotRegress.class), TableHeader.TEST_TYPE);
